...
# DIRECTORY = ./src/1_Randomness/
# FILE = pseudo_random
# ADDONS = ./src/addon_src/util.c ./src/addon_src/raylib_extended.c
# all:
# 	emcc -o ./webbuild/${FILE}/${FILE}.html ${DIRECTORY}${FILE}.c ${ADDONS} -Wall -std=c99 -D_DEFAULT_SOURCE -Wno-missing-braces -Wunused-result -Os -I./include -I E:/raylib/raylib/src -I E:/raylib/raylib/src/external -L. -L E:/raylib/raylib/src -s USE_GLFW=3 -s ASYNCIFY -s TOTAL_MEMORY=67108864 -s FORCE_FILESYSTEM=1 --shell-file E:/raylib/raylib/src/shell.html E:/raylib/raylib/src/web/libraylib.a -DPLATFORM_WEB -s EXPORTED_FUNCTIONS=["_free","_malloc","_main"] -s EXPORTED_RUNTIME_METHODS=ccall
# SRC_DIR := ./src
# ADDON_SRC := ./src/addon_src
# WEB_BUILD := ./webbuild
